...
OPTION1=$(zenity --list --radiolist  --width 900 --height 300\
       ...
       TRUE "Универсальный, быстро, без потерь качества" FALSE "Классика, Ghostscript" FALSE "Медленнее, сильнее сжатие, без потерь качества" FALSE "Чуть быстрее, сильное сжатие, чуть хуже качество"  FALSE "Медленнее, очень сильное сжатие, заметная потеря качества" FALSE "Ещё медленнее, ещё сильнее сжатие, заметная потеря качества, и разрешения вдвое")
if [ "$OPTION1" = "Универсальный, быстро, без потерь качества"  ] ; then OPTION=compress-pdf-standart.sh;
	else  OPTION=pdf-manager.sh; fi
if [ "$OPTION1" = "Медленнее, сильнее сжатие, без потерь качества"   ] ; then OPTION=compress-pdf-experimental1.sh; fi
